...
When you run the program, you can add new habits, mark habits complete for today, show today's habit completion status, or quit the program. Your progress is saved automatically.# AIML-Project
